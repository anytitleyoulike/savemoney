                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                    {% for orcamento in result %}
                                    <tr class="danger">
                                        <td><a href="/savemoney/orcamento/update/{{orcamento.id}}">{{orcamento.categoria.cat_nome}}</a></td>
                                        <td>R$ {{orcamento.valor}}</td>
                                        <td><a href="/savemoney/orcamento/remove/{{orcamento.id}}" onclick="removeOrcamentgo()">Excluir</a></td>
                                    </tr>
                                    {% endfor %}
                                   </tbody>
                                </table>
