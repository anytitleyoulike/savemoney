                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="descricao" id="inputDescrib" value="{{receita.descricao}}"placeholder="Descreva a receita">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputValue" class="col-lg-2 control-label">Valor</label>
                                    <div class="col-lg-10">
                                        <input type="number" name="valor" class="form-control" id="inputValue" value="{{receita.valor}}" placeholder="Valor da receita">
                                    </div>
                                </div>
