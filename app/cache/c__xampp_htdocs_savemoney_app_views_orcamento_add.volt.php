...
<body>
<form name='add' method="post" action="/savemoney/orcamento/add">
<div class="container">
    <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Adicionar Orcamento</h3>
                            </div>
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="col-lg-10">
                                                <select class="form-control" name="categoria" id="select">
                                                    <?php foreach ($categoria as $cat) { ?>
                                                        <?php if ($cat->cat_id != $orcamento->catId) { ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-10 col-lg-offset-2">
                                                ...
                                                <button type="submit" class="btn btn-primary" onClick="adicionarOrcamento()">Salvar</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
...
<script>
    $(document).ready(function() {
     ...
     function adicionarOrçamento(){
        alert("Orçamento adicionada com sucesso!");
    }
